...
COPY Lab2.Authors FROM stdin USING DELIMITERS '|' ;
...
COPY Lab2.Books FROM stdin USING DELIMITERS '|' ;
ccfyls|643|Foe Without A Home|92152|1682-11-14|9300.65|F|2018-01-11|1
kgoetm|2789|Doctor Of The Plague|17265|\N|400.55|F|2018-03-14|25
jvlfno|3372|Thieves Of Freedom|25327|1691-10-05|63.5|F|2018-04-21|30
zdulmo|1306|Armies Of The Great|55576|1729-06-30|52.45|F|2018-06-10|30
...
dmfnth|1561|Bow Of Freedom|98035|1933-08-11|28.72|F|2018-10-04|29
...
COPY Lab2.Members FROM stdin USING DELIMITERS '|' ;
...
2222|John Smith|2018-06-05|2019-06-05|TRUE
3333|John Smith|2018-07-05|2019-07-05|TRUE
4444|John Smith|2018-08-05|2019-08-05|TRUE
\.

COPY Lab2.Orders FROM stdin USING DELIMITERS '|' ;
...
COPY Lab2.Publishers FROM stdin USING DELIMITERS '|' ;
...
COPY Lab2.Reviews FROM stdin USING DELIMITERS '|' ;
